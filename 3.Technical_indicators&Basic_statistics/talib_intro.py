# -*- coding: utf-8 -*-
"""
Created on Tue Sep 15 18:21:28 2020
...
'''
ta-lib is a technical analysis library with a bunch of funtions to look into technical indicators, etc. 

A very interesting part of such library is the pattern recognition one. 

ta-lib is coded in c++ and wrapped into python so install it via pip might not work for some people.
