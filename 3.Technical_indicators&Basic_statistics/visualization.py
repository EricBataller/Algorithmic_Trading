...
close_prices.plot(subplots=True, sharex=True, layout = (3,2), title = "Tech Stock Price Evolution", grid =True) # Subplots of the stocks. Sharex means the subplots share the x axis
