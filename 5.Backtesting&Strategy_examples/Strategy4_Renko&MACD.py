# -*- coding: utf-8 -*-
"""
Created on Fri Sep 18 18:42:28 2020
...
'''
Combination of Renko charts and MACD indicator

Chose high volume, high activity stocks for this strategy (pre market movers,
historically high volume stocks etc.)

Buy Signal:
      - Ranko bar greater than or equal to 2
      - MACD line is above the signal line
      - MACD line's slope (over last 5 periods) is greater than signal line's 
        slope (over last 5 periods). (In other words, when the MACD line corsses
        the signal line from below)
      - Exit when MACD line goes below the signal line and MACD line's slope is
        lower than signal line's slope.
        
Sell Signal:
      - Ranko bar less than or equal to -2
      - MACD line is below the signal line
      - MACD line's slope (over last 5 periods) is less than signal line's 
        slope (over last 5 periods).
      - Exit when MACD line goes above the signal line and MACD line's slope is
        greater than signal line's slope.
